...
const History = () => {
	...
	return (
		<div className="min-h-screen bg-white">
			<div className="grid w-full min-h-full grid-cols-5 grid-rows-4 p-20 gap-x-20 gap-y-20">
...
// className="grid grid-cols-4 p-5 mx-56 mb-32 tbl:mx-auto dt:grid-cols-3 tbl:grid-cols-3 mbl:grid-cols-1 gap-x-4 gap-y-4"
